...
namespace NDoc3.Core {
	...
	public class Project {
		...
		public Project() {
			...
			_namespaces.ContentsChanged += ContentsChanged;

			_AssemblySlashDocs = new AssemblySlashDocCollection();
			_AssemblySlashDocs.Cleared += _AssemblySlashDocs_Cleared;
			_AssemblySlashDocs.ItemAdded += _AssemblySlashDocs_ItemAdded;
			_AssemblySlashDocs.ItemRemoved += _AssemblySlashDocs_ItemRemoved;
		}
		...
		public string ProjectFile {
			...
			set {
				...
				PathItemBase.BasePath = !string.IsNullOrEmpty(value) ? Path.GetDirectoryName(value) : null;
		...
		private bool _suspendDirtyCheck;
		...
		private readonly AssemblySlashDocCollection _AssemblySlashDocs;
