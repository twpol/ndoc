		...
		<xsl:choose>
			<xsl:when test="@langword='null'">
				<xsl:text>a null reference</xsl:text>
				  (<b>Nothing</b><xsl:text> in Visual Basic)</xsl:text>
			</xsl:when>
			<xsl:when test="@langword='sealed'">
				<xsl:text>sealed</xsl:text>
				(<b>NotInheritable</b><xsl:text> in Visual Basic)</xsl:text>
			</xsl:when>
			<xsl:when test="@langword='static'">
				<xsl:text>static</xsl:text>
				(<b>Shared</b><xsl:text> in Visual Basic)</xsl:text>
			</xsl:when>
			<xsl:when test="@langword='abstract'">
				<xsl:text>abstract</xsl:text>
				(<b>MustInherit</b><xsl:text> in Visual Basic)</xsl:text>
			</xsl:when>
