// AboutForm.cs - About box form for NDoc3 GUI interface.
...
namespace NDoc3.Gui
{
	...
	public class AboutForm : System.Windows.Forms.Form
	{
		...
		public AboutForm()
		{
			...
			Stream stream = assembly.GetManifestResourceStream("NDoc3.Gui.About.rtf");
			richTextBox.LoadFile(stream, RichTextBoxStreamType.RichText);

			// Set up web links
			projectHomePageLinkLabel.Links.Add(19, 28, "http://ndoc3.sourceforge.net");
			...
			try 
			{
				...
				foreach (ProcessModule module in Process.GetCurrentProcess().Modules)
				{
					...
					if (module.ModuleName.ToLower().StartsWith("ndoc3"))
					{
						ndocItems.Add(item);
					}
				}

				// Extract the NDoc3 related modules and move them to the top
			...
			{
				MessageBox.Show(this, ex.ToString(), "NDoc3 Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
		...
		private void InitializeComponent()
		{
            ...
            this.versionHeaderGroupBox = new System.Windows.Forms.GroupBox();
            ...
            this.closeButton.Location = new System.Drawing.Point(438, 397);
            ...
            // 
            this.versionHeaderGroupBox.Anchor = System.Windows.Forms.AnchorStyles.None;
            ...
            this.versionHeaderGroupBox.Location = new System.Drawing.Point(8, 223);
            ...
            this.projectHomePageLinkLabel.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.projectHomePageLinkLabel.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.projectHomePageLinkLabel.Text = "Project home page: http://ndoc3.sourceforge.net";
            ...
            this.developersLabel.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.developersLabel.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.developersLabel.Location = new System.Drawing.Point(88, 200);
            this.developersLabel.Name = "developersLabel";
            this.developersLabel.Size = new System.Drawing.Size(440, 17);
            ...
            this.adminsLabel.Font = new System.Drawing.Font("Verdana", 8.25F);
            this.adminsLabel.Location = new System.Drawing.Point(128, 176);
            this.adminsLabel.Name = "adminsLabel";
            this.adminsLabel.Size = new System.Drawing.Size(101, 13);
            this.adminsLabel.TabIndex = 10;
            this.adminsLabel.Text = "Kim Christensen";
            // 
            // AboutForm
            // 
